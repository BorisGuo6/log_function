...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='Advantage Actor-Critic (A2C) agent')
    # env
    ...
    log_name = "alg-a2c_logad_env-{}_optimizer-{}_pi_lr-{}_seed-{}_{}".format(args.env_name, args.optimizer, args.pi_lr, args.seed, suffix)
    log_dir = os.path.join('./tensorboard_log/' + log_name)
    print('log_dir =', log_dir)
    tb_writer = SummaryWriter(log_dir)

    for episode in range(1, MAX_EPISODES+1):
        policy_loss, value_loss, train_reward = train(train_env, ac, pi_optimizer, vf_optimizer, DISCOUNT_FACTOR)
